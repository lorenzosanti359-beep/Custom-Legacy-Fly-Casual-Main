...
namespace RulesList
{
    public class ActionsRule
    {
        ...
        public void ActionColorCheck(GenericAction action)
        {
            ...
            //AI ora compie azioni rosse (Rotate Arc, Barrel Roll) quando la valutazione
            // lo giustifica: il trigger dello stress deve applicarsi anche a lei, esattamente
            // come già avviene per la spesa di Force sulle azioni viola qui sotto, che non
            // ha mai avuto un'esclusione simile.
