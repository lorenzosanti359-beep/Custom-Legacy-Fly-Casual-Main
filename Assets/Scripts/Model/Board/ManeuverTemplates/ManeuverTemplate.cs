...
namespace BoardTools
{
    public class ManeuverTemplate
    {
        ...
        /// <summary>
        /// Attiva/disattiva il GameObject del template senza distruggerlo. Usato per
        /// riutilizzare una singola istanza in valutazioni ripetute (es. euristica AI)
        /// senza mai renderizzarla sul tavolo. Nessun effetto se ApplyTemplate non è
        /// ancora mai stato chiamato.
        /// </summary>
        public void SetVisible(bool visible)
        {
            if (TemplateGO != null)
            {
                TemplateGO.SetActive(visible);
            }
        }

        /// <summary>
        /// True se il GameObject sottostante esiste ancora. Un'istanza cached può
        /// diventare invalida tra una partita e l'altra se la gerarchia del tavolo
        /// (Board.GetBoard()) viene distrutta e ricreata: questo permette al chiamante
        /// di accorgersene e ricreare l'istanza invece di usarne una "fake null".
        /// </summary>
        public bool IsAlive => TemplateGO != null;
